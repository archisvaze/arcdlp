...
// Cookie file lives in temp dir, auto-cleaned by OS
let cookiePath = null;
...
/** Check if we have a saved YouTube session */
...
/** Get the cookie file path if cookies exist, or null */
...
/** Open YouTube login window. Returns true if login detected. */
function openLoginWindow(parentWindow) {
    return new Promise((resolve) => {
        ...
        // Watch for navigation to youtube.com (login success)
...
/** Clear all YouTube cookies (logout) */
...
/** Extract cookies from Electron session and write Netscape format file */
